  ...
  return (
    <div className="review-form">
        <div className="form-control score-container">
          ...
          <label className="radio-container">
            <input type="radio" value="satisfield" name="review" checked={ data.review === "satisfield" } onChange={(e) => updateFieldHandler("review", e.target.value)} required/>
            <BsFillEmojiSmileFill/>
            <p>Satisfeito</p>
          </label>
          <label className="radio-container">
            <input type="radio" value="very_satisfield" name="review" checked={ data.review === "very_satisfield" } onChange={(e) => updateFieldHandler("review", e.target.value)} required/>
